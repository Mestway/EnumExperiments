...
public class FilterEnumerator {
    ...
    public static List<Filter> enumCanonicalFilterNamedTable(AbsNamedTable tn, EnumContext ec) {
    ...
    // Generated filters are used for filtering the renamed table rt
    public static List<Filter> enumCanonicalFilterJoinNode(AbsRenameNode rt, EnumContext ec) {

        if (! (rt.getTableNode() instanceof AbsJoinNode))
            System.out.println("[ERROR EnumCanonicalFilters 44] " + rt.getTableNode().getClass());

        AbsJoinNode jn = (AbsJoinNode) rt.getTableNode();
    ...
    // Generated filters are used for filtering the renamed table rt
    public static List<Filter> enumCanonicalFilterAggrNode(AbsRenameNode rt, EnumContext ec) {

        if (! (rt.getTableNode() instanceof AbsAggrNode))
            System.out.println("[ERROR@EnumCanonicalFilters 44] " + rt.getTableNode().getClass());

        AbsAggrNode an =(AbsAggrNode) rt.getTableNode();
